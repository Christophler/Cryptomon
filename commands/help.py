...
async def help(message, discord):
    ...
    await message.channel.send('Welcome to Cryptomon, a text-based game where you use graphic cards to catch cryptocurrency. \n', file=discord.File('images/welcomeCrypto.jpg')) # THIS REQUIRES THE 'welcomeCrypto.jpg'
    ...
    await message.channel.send('**$validate**: Attempts to catch the crypto you mined.')
